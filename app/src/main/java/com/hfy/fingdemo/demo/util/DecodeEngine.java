package com.hfy.fingdemo.demo.util;
...
import com.hfy.fingdemo.demo.common.Constant;
import com.hfy.fingdemo.demo.ssrc.SSRC;
...
public class DecodeEngine {
    ...
    public boolean convertMusicFileToPcmFile(String musicFileUrl, String decodeFileUrl,
        ...
        if (decodeOperateInterface != null) {
            if (success) {
                Log.w("AudioEdit", "-------convertMusicFileToPcmFile--- success ttt" );
                decodeOperateInterface.decodeSuccess();
            } else {
                Log.w("AudioEdit", "-------convertMusicFileToPcmFile--- success fffff" );
                decodeOperateInterface.decodeFail();
            }
        }
